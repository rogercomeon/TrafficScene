...
def resnet50(pretrained=True, root='~/.encoding/models',**kwargs):
    ...
    model.load_state_dict(torch.load('./pretrained/resnet50-25c4b509.pth'), strict=True)
...
def resnet101(pretrained=True, root='~/.encoding/models',**kwargs):
    ...
    model.load_state_dict(torch.load('./pretrained/resnet101-2a57e44d.pth'), strict=True)
    print('load preTrained resnet100')
    return model
